                        ...
                        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <div id="content">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <form:form action="/editF" method="post" modelAttribute="currentBook">
                                        <div class="form-group" style="display: none;">
                                            <label for="exampleInputPassword1">Id</label>
                                            <form:input type="text" class="form-control" id="exampleInputPassword1"
                                                placeholder="Password" value="${book.id}" path="id" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Name Of The Book</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input type="text" class="form-control" id="exampleInputPassword1"
                                                placeholder="Password" value="${book.year}" path="year" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Publisher</label>
                                            <form:input type="text" class="form-control" id="exampleInputPassword1"
                                                placeholder="Password" value="${book.publisher}" path="publisher" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">ShortDes</label>
                                            <form:input type="text" class="form-control" id="exampleInputPassword1"
                                                placeholder="Password" value="${book.shortDes}" path="shortDes" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">DetailDes</label>
                                            <form:input type="text" class="form-control" id="exampleInputPassword1"
                                                placeholder="Password" value="${book.detailDes}" path="detailDes" />
                                        </div>
