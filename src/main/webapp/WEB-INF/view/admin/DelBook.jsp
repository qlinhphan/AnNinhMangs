                            ...
                            <div id="content">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800">Delete A Book</h1>

                                    </div>


                                    <div class="alert alert-success" role="alert">
                                        <h4 class="alert-heading" style="color: red;">Warning</h4>
                                        <p>Bạn sắp thực hiện hành động xóa quyển sách này khỏi cơ sở dữ liệu. Hãy chắc
                                            chắn rằng bạn đã cân nhắc kỹ, vì sau khi xóa, toàn bộ thông tin liên quan
                                            đến quyển sách sẽ không thể khôi phục lại. Bạn có muốn tiếp tục không?</p>
                                        <hr>
                                        <p class="mb-0">Bất cứ khi nào bạn chắc chắn hãy click "YES"</p>
                                        <form:form action="/delBookOk" mothod="post" modelAttribute="ObjDel">
                                            <div style="display: none;">
                                                <form:input type="text" value="${bok.id}" path="id" />
                                            </div>
                                            <button type="submit" class="btn btn-danger"
                                                style="margin-left: 47%; margin-top: 17px;">Yes</button>
                                        </form:form>
                                    </div>
