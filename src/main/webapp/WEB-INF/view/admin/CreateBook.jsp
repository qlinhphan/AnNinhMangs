                                                            ...
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="card-body p-md-5 text-black">
                                                                        <h3 class="mb-5 text-uppercase">Create A Book
                                                                        </h3>
                                                                            ...
                                                                            <div class="col-md-6 mb-4">
                                                                                <div data-mdb-input-init
                                                                                    ...
                                                                                    <label class="form-label"
                                                                                        for="form3Example1m">FullName Of
                                                                                        Book</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6 mb-4">
                                                                                <div data-mdb-input-init
                                                                                    ...
                                                                                    <form:input type="text"
                                                                                        ...
                                                                                        path="publisher" />
                                                                                    <label class="form-label"
                                                                                        for="form3Example1n">Publisher</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="col-md-6 mb-4">
                                                                                <div data-mdb-input-init
                                                                                    ...
                                                                                    <form:input type="text"
                                                                                        ...
                                                                                        path="year" />
                                                                                    <label class="form-label"
                                                                                        for="form3Example1m1">Year</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6 mb-4">
                                                                                <div data-mdb-input-init
                                                                                    ...
                                                                                    <form:input type="text"
                                                                                        ...
                                                                                        path="shortDes" />
                                                                                    <label class="form-label"
                                                                                        for="form3Example1n1">ShortDes</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div data-mdb-input-init
                                                                            ...
                                                                            <form:input type="text" id="form3Example8"
                                                                                class="form-control form-control-lg"
                                                                                path="detailDes" />
                                                                            <label class="form-label"
